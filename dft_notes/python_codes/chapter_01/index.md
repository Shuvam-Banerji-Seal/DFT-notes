...
| 03 | [03-hydrogen-orbitals.py]({{ site.baseurl }}/dft-notes/python_codes/chapter_01/03-hydrogen-orbitals.py) | [03-hydrogen-orbitals.png]({{ site.baseurl }}/dft_notes/python_codes/chapter_01/plots/03-hydrogen-orbitals.png) | §1.10 — "The hydrogen atom".  Radial eigenfunctions $R_{n\ell}(r)$ for the six lowest states and their radial probability densities $P_{n\ell}(r) = r^2 |R_{n\ell}|^2$, with the analytic mean radii $\langle r\rangle_{n\ell} = a_0(3n^2 - \ell(\ell+1))/2$ marked.  Verifies the 1s peak at $r = a_0$. |
