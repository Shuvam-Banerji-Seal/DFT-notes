...
|:---|:-------|:-----|:-------------|
| 01 | [01-free-electron-bands.py]({{ site.baseurl }}/dft-notes/python_codes/chapter_07/01-free-electron-bands.py) | [01-free-electron-bands.png]({{ site.baseurl }}/dft-notes/python_codes/chapter_07/plots/01-free-electron-bands.png) | Builds the 21×21 plane-wave Hamiltonian in reciprocal space for $V(x) = -0.5\cos(2\pi x/a)$ at $a = 5$ bohr, diagonalises at 100 k-points, plots the first 4 bands. The BZ-boundary gap of 0.488 E_h matches the 2×2 analytic leading-order result. |
