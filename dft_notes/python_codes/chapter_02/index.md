...
| 02 | [02-helium-sto.py]({{ site.baseurl }}/dft_notes/python_codes/chapter_02/02-helium-sto.py) | [02-helium-sto.png]({{ site.baseurl }}/dft_notes/python_codes/chapter_02/plots/02-helium-sto.png) | Helium atom in a single 1s STO: closed-shell singlet energy $E(\zeta)=\zeta^2-4\zeta+\frac{5}{8}\zeta$ minimised at $\zeta^\*=27/16=1.6875$ with $E_{\min}=-729/256=-2.8477\,E_h$.  The plot shows the variational curve, the optimum, and the missing correlation relative to the Hylleraas reference $E=-2.8617\,E_h$. |
