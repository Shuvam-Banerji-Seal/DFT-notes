...
metho`d*`* (Lehmann–Taut 1972; Blöchl 1994).  We derived it in detail
...
the effective mass tensor is *anisotropi`c*`: the curvature of the
...
- **Valley-selective optical excitation.**  The $K$ and $K'$
  ...
  luminescence is *circularly polarise`d*`.  This is the **valley
